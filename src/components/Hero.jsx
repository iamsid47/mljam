          ...
          <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="  px-8 mt-12 space-y-5">
                <form>
                  <div className="w-full max-w-lg md:ml-auto mx-auto">
                    <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                      <div className="w-full">
                        <input
                          ...
                          id="email"
                          name="email"
                          className="py-3 px-4 block w-full shadow-sm rounded-md focus:z-10 focus:border-blue-500 focus:ring-blue-500 ring-1 transition duration-300 bg-slate-900 border-gray-700 text-gray-400"
                          placeholder="Enter your email for a free ticket"
                        />
                      </div>
                      <a
